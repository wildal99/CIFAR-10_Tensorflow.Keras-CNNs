...
Original file is located at
    https://colab.research.google.com/drive/1cNtHF1h7PJ1o-h0B113IaT-4kWxMJT4I
"""
#Achieves about 75% accuracy in 205 seconds using the t4 gpu in colab

#Instal keras in colab
...
model = models.Sequential([
    ...
    #keeping the input shape parameter for each of these layers seems to improve accuracy for some reason.
    ...
    layers.Conv2D(filters=512, kernel_size=(2,2), activation = 'relu', padding ='same'),
